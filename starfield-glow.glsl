...
// divisions of grid (lower = fewer stars)
const float repeats = 12.;

// number of layers (lower = fewer stars)
const float layers = 8.;

// speed multiplier (lower = slower drift)
const float speed = 0.08;

// overall brightness (lower = more subtle)
const float brightness = 0.35;

// star color — neutral warm gray instead of pure white
const vec3 starColor = vec3(0.7, 0.7, 0.65);
...
vec3 stars(vec2 uv, float offset) {
    ...
    col += starColor * sparkle * brightness;
